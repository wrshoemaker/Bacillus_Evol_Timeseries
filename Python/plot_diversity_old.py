...
ax_fixed = fig.add_subplot(gs[3:6, 1:3])
...
axes = [ax_hyper_0, ax_hyper_1, ax_hyper_2, ax_M_max, ax_K, ax_fixed]
...
ax_M_max.set_xlabel('Maximum value of ' + r'$M(t)$' + ', ' + r'$\left [ \mathrm{log}_{10} M \right ]_{\mathrm{max}}$', fontsize = 12)
...
ax_M_max.text(-0.2, 0.5, "Day(s)", fontsize=14, rotation=90, ha='center', va='center', transform=ax_M_max.transAxes)
ax_K.text(-0.2, 0.5, "Day(s)", fontsize=14, rotation=90, ha='center', va='center', transform=ax_K.transAxes)
...
fig.subplots_adjust(hspace=0.8, wspace=0.3) #hspace=0.3, wspace=0.5
